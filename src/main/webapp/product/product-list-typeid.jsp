...
<div class="page-container">
	...
	<div class="page-container">
		...
		<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a class="btn btn-primary radius" onclick="product_add('添加产品','product-add?id=${requestScope.list1}')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加产品</a> </span><!-- <span class="r">共有数据：<strong>54</strong> 条</span> -->  </div>
		<div class="mt-20">
...
function product_stop(obj,id){
	...
	$.ajax({
		...
		$('#mainContent'+dates[0].id).html(dates[0].status_name);  //局部刷新
